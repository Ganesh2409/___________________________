...
// So try to use the pivot as any random value in the array 
    ...
    void quickSort(int arr[], int l, int r)
    {
        ...
        quickSort(arr,pivot_id+1,r); // here we are using our recursion to sort the left and right eles of the pivot which has been returned from the partion function 
        // in this step the partition function is called multiple times and palcing the pivot at its place and soring the left and right parts of the pivot 
        // code here
    }
    ...
    int partition (int arr[], int l, int r)
    {
	    ...
	    for(int i=l;i<r;i++){ // we are stating from the left and right 
	     ...
	     int index =l; // --> starting from the index left(l) and filling upto the index right(r)
